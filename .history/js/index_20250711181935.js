...
let loginTwo = document.getElementById("login-2");

// لو فيه سكاشن تانية مفتوحة محتاج تقفلها كمان (اختياري)
signinLink.addEventListener("click", function (e) {
  e.preventDefault(); // علشان ما يعملش reload

  // إظهار login-2
  loginTwo.classList.remove("d-none");

  // ممكن تضيف هنا إخفاء باقي السكاشن لو حابب
  // مثلاً:
