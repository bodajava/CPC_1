...
let containers = [
  document.querySelector("#lightBoxContainer1"),
  document.querySelector("#lightBoxContainer2"),
  document.querySelector("#lightBoxContainer3"),
];

// لما تضغط على أي كارد يظهر الفورم المقابل له
