...
<!-- في نهاية الـ <body> -->
<script src="https://unpkg.com/lenis@latest/bundled/lenis.min.js"></script>
<script>
const lenis = new Lenis({
  duration: 1.5,          // زمن 100vh في ثواني (كبّره = أبطأ)
  smoothWheel: true,      // يفَعِّل التنعيم لعجلة الفأرة
  smoothTouch: true       // يشمل اللمس بالموبايل
});
function raf(t){
  lenis.raf(t);
