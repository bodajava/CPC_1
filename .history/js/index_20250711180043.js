...
// لما تضغط على كارد 3 يظهر login-2
for (let i = 0; i < cardThree.length; i++) {
  cardThree[i].addEventListener("click", function () {
    loginTwo.classList.remove("d-none");
  });
...
// لما تضغط على زرار Create Account من login-2 يظهر creatAccMealFemal
let createBtnInLoginTwo = document.querySelector("#login-2 .create-acc-btn");

createBtnInLoginTwo.addEventListener("click", function (e) {
  e.preventDefault(); // علشان ما يعملش submit للفورم
  loginTwo.classList.add("d-none");
