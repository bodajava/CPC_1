...
document.addEventListener("DOMContentLoaded", function () {
  const scrollSpy = new bootstrap.ScrollSpy(document.body, {
    target: "#mainNavbar", // The ID of your navbar
    offset: 100, // Same as data-bs-offset in your HTML
  });
  ...
  document.querySelectorAll(".navbar-nav .nav-link").forEach((anchor) => {
    anchor.addEventListener("click", function (e) {
      ...
      // Manually update active class (optional, as scrollspy handles this)
  ...
  // Optional: Update active class on scroll (if scrollspy doesn't work as expected)
